@extends('layouts.app')
@section('title','Kathit | Admin Register')
    ...
    <div class="container-fluid row gx-0 gx-md-3">
      ...
      <div class="col-12 col-md-6 px-4 px-md-5 position-relative">
        <div class="admin-login-form">
          <h3 class="mb-4 py-2 lr-head">SignUp As <span class="highlight">Super Admin</span></h3>
          ...
          <div class="my-4 text-center">
            <p class="mb-0">Already Have an Account? <a href="{{ url('/adminlogin') }}" class="register-link">Login</a></p>
          </div>
        </div>
      </div>
    </div>
