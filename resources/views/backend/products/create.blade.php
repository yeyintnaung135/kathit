...
@section('title','Kathit | Product Create')
@push('styles')
  <style>
    .dropzone {
        background: white;
                ...
                {{-- <form method="post" action="{{url('backend/product/store')}}" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="form-group row no-gutters mb-0">
                      <div class="col-12 col-md-6 pr-0 pr-md-2 mb-3">
                      ...
                      <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="d-flex mt-2">
                          <div class="form-check mr-4">
                            <input class="form-check-input" name="type" type="checkbox" value="readytowear" id="readytowear" {{is_array(old('type')) ? (in_array('readytowear', old('type')) ? 'checked' : '') : ''}}>
                            <label class="form-check-label" for="readytowear">
                              Ready To Wear
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" name="type" type="checkbox" value="customize" id="customize" {{is_array(old('type')) ? (in_array('customize', old('type')) ? 'checked' : '') : ''}}>
                    ...
                    <div class="form-group row no-gutters">
                      <div class="col-12 col-md-6 pr-md-2 mb-3 readytowear-price d-none">
                        ...
                        <input type="number" name="s_price"
                              ...
                              id="exampleInputEmail1" value="{{old('s_price')}}"
                              placeholder="Enter Small Price" required min="0"
                        >
                      </div>
                      <div class="col-12 col-md-6 pr-md-2 mb-3 readytowear-price d-none">
                        ...
                        <input type="number" name="m_price"
                              ...
                              id="exampleInputEmail1" value="{{old('m_price')}}"
                              placeholder="Enter Medium Price" required min="0"
                        >
                      </div>
                      <div class="col-12 col-md-6 pr-md-2 mb-3 readytowear-price d-none">
                        ...
                        <input type="number" name="l_price"
                              ...
                              id="exampleInputEmail1" value="{{old('l_price')}}"
                              placeholder="Enter Large Price" required min="0"
                        >
                      </div>
                      <div class="col-12 col-md-6 pr-md-2 mb-3 readytowear-price d-none">
                        ...
                        <input type="number" name="xl_price"
                              ...
                              id="exampleInputEmail1" value="{{old('xl_price')}}"
                              placeholder="Enter XL Price" required min="0"
                        >
                      </div>
                      <div class="col-12 col-md-6 pr-md-2 mb-3 readytowear-price d-none">
                        ...
                        <input type="number" name="xxl_price"
                              ...
                              id="exampleInputEmail1" value="{{old('xxl_price')}}"
                              placeholder="Enter XXL Price" required min="0"
                        >
                      </div>
                      <div class="col-12 col-md-6 pr-md-2 mb-3 customize-price d-none">
                        ...
                        <input type="number" name="customize_price"
                              ...
                              id="exampleInputEmail1" value="{{old('customize_price')}}"
                              placeholder="Enter Customize Price" required min="0"
                        >
                      </div>
                      <div class="col-12 col-md-6">
                        <label>Category</label>
                        <select class="form-control" name="category_id">
                            <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>Dress</option>
                            <option value="2" {{ old('type') == '1' ? 'selected' : '' }}>Myanmar Dress</option>
                            <option value="3" {{ old('type') == '1' ? 'selected' : '' }}>Men's Wear</option>
                            <option value="4" {{ old('type') == '1' ? 'selected' : '' }}>Women's Wear</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row no-gutters">
                      <div class="col-12 col-md-12">
                        ...
                        <div id="preview-template" style="display: none;">
                          <div class="dz-preview dz-file-preview">
                            <div class="dz-image">
                              <img data-dz-thumbnail="" class="dz-sn-image w-100">
                            </div>
                    ...
                    <div class="form-group row no-gutters">
                      <div class="col-12 col-md-6 pr-md-2">
                        ...
                        <input type="hidden" id="color" name="color" value="{{ old('color') ? old('color') : '[]' }}">
                        <div class="sn-multiple-selection">
                          ...
                          <div class="sn-checkbox-dropdown sn-dropdown-state d-none">
                            @foreach($colors as $color)
                              @if (in_array($color->id, old('color') ? json_decode(old('color')) : []))
                                <div
                                  class="sn-gem-list"
                                >
                                  <input
                      ...
                      <div class="col-12 col-md-6">
                          ...
                          <input type="text" name="brand_code"
                                ...
                                id="exampleInputEmail1" value="{{old('brand_code')}}"
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                  <div class="card card-outline card-info">
                                      <div class="card-header">
                                          <h3 class="card-title">
                                              Description <span style="color:red;font-size:13px;font-weight:bold;">*</span>
                                          </h3>
                                      </div>
                                      <!-- /.card-header -->
                                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="card card-outline card-info">
                                <div class="card-header">
                                    <h3 class="card-title">
                                      About Product <span style="color:red;font-size:13px;font-weight:bold;">*</span>
                                    </h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
